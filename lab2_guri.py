...
print("\nExercise 5")
day_today = int(input('What is the day number? '))
days_trip = int(input('What is the duration of your trip'))
final_output = (days_trip + day_today)  % 7

print(f'Your trips starts on day ', day_today , 'lasts ' , days_trip , '.You are back on day ', final_output)
